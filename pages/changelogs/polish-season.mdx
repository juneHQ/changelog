...
export const meta = {
  slug: "polish-season",
  publishedAt: "2024-12-27T11:32:58.508Z",
  title: "Polish Season",
  headerImage: "https://june-changelog.s3.eu-central-1.amazonaws.com/polish-season/header.png",
...
This week we've fixed a bunch of critical bugs, but a lot of our team was on vacation - so no big highlights, just a lot of customer facing bug fixes and small enhancements.

- We added the ability to select the "contains" and "does not contain" property filters for event alerts.

- We fixed an issue that was causing delays in importing data from Amplitude and Mixpanel.

- We fixed a bug with how traits get added from the people list when there are many audience filters.

- Fixed an issue with many re-renders happening in the UI when updating a dashboard.

- Updated the behavior of adding insights to a dashboard to add them at the end of the grid.
