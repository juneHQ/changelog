...
export const meta = {
  slug: "lets-fix-some-bugs",
  publishedAt: "2023-09-15T09:00:00.000Z",
  title: "Let's fix some bugs",
  headerImage: "https://june-changelog.s3.eu-central-1.amazonaws.com/lets-fix-some-bugs/header.png",
  authors: [
    {
...
This week we focused on fixing bugs and improving the overall experience of June.

The main areas of improvement are:

- We redesigned and improved the rough edges of the Hubspot and Attio integrations to make them more intuitive and reliable.
- We improved the design and experience of using the June CMD-K shortcut to quickly navigate to any page in June.
