...
export var PaginatedArticles = function (_a) {
    var page = _a.page, children = _a.children;
    var metaTitle = "".concat(page > 0 ? "Page ".concat(page, " -") : "", " Zing Changelog");
    return (<>
      <Head>
      ...
      <Box w="full" maxW="100vw" overflow="hidden" zIndex="docked">
        <Container maxW="landingMax" px={defaultPx(32)} mt={[86, 86, 140]}>
          <VStack>
            ...
            <HStack>
              <Text as="a" fontSize="lg" color="primary" href="https://twitter.com/intent/follow?screen_name=JuneDotSo" target="_blank" rel="noopener noreferrer">
          ...
          <VStack spacing={16} divider={<Divider />}>
            ...
            <VStack align={["stretch", "stretch", "center"]}>
              {page === 0 ? (<Link href="/page/1">
                  <Button variant="landingOutline" size="landingLg">
                    Load more
                  </Button>
                </Link>) : (<HStack justifyContent="center" spacing={4}>
                  {page > 0 && (<Link href={"/page/".concat(page - 1)}>
                      <Button variant="landingOutline" size="landingLg">
                        Previous page
                      </Button>
                    </Link>)}
                  <Link href={"/page/".concat(page + 1)}>
                    <Button variant="landingOutline" size="landingLg">
                      Next page
                    </Button>
                  </Link>
